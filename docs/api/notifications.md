...
**« Nouvelle vente » inclut le nom des produits vendus (décision actée 2026-09-14)** : le corps de la notification n'était qu'un montant (ex. « 3 000 FCFA ») — demande utilisateur explicite, il liste désormais aussi les produits, dédupliqués dans l'ordre d'apparition (ex. « Heineken 33, Poulet Braisé — 3 000 FCFA »). Une même vente avec plusieurs lignes du même produit (ex. deux prix différents pour une catégorie à prix variable) ne le répète qu'une fois.
