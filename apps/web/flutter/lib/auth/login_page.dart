  ...
  Future<void> _sendOtp() async {
    ...
    try {
      ...
      Navigator.of(context).push(
        MaterialPageRoute(builder: (_) => OtpVerifyPage(email: _emailController.text.trim())),
      );
    } on AuthException catch (e) {
      _showError(e.message);
    } finally {
          ...
          child: Padding(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ClipOval(child: Image.asset('assets/logo.png', height: 64, width: 64)),
                  const SizedBox(height: 12),
                  const Text('Chez Yasmine', textAlign: TextAlign.center, style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
