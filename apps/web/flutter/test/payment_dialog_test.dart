...
void main() {
  ...
  testWidgets(
    'the submit button is disabled until at least one payment line is added',
    (tester) async {
      ...
      expect(
        button.onPressed,
        isNull,
        reason: 'the amount field being pre-filled does not itself add a payment line',
      );
    },
  );

  testWidgets(
    'splitting the payment across two methods sums correctly and then enables submission',
    (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Builder(
  ...
  testWidgets('removing a payment line updates the remaining balance', (
    tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
